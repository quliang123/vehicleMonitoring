        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="../jsp/SSGJ.jsp"><i class="fa fa-circle-o"></i> 实时告警</a></li>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <input type="text" name="" value="车牌号"/>
                        ...
                        <input  type="button" value="搜索" style="background: #0d6aad"/>
                        <input type="button" value="重置" style="background: #0d6aad"/>
                        <div class="box-body">
