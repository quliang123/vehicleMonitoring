    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../jsp/GZTJ.jsp"><i class="fa fa-circle-o"></i>故障统计</a></li>
              </ul>
            </li>
          </ul>
        </section>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           车辆故障统计
            <small>Vehicle fault statistics</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <!--车牌号--><input type="text" a placeholder="车牌号" style="width: 150px;height: 30px" />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <!--时间--><span>时间</span>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="button" class="btn btn-default" style="width: 100px;height: 30px">重置</button>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                  <button type="button" class="btn btn-default" style="width: 100px;height: 30px">导出</button>
                </div><!-- /.box-header -->
                <div >
