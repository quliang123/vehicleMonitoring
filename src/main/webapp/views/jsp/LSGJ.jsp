          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="../jsp/LSGJ.jsp"><i class="fa fa-circle-o"></i> 历史告警</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <input type="button" value="导出" input{text-align:right;} style="margin-left:1910px;" />

                </div><!-- /.box-header -->
                <hr/>

                <input type="text" name="" style="height: 40px;"/>&nbsp;&nbsp;
                <input  type="text" name="" style="height: 40px;"/>&nbsp;&nbsp;

                <select name="book_type"  style="height: 40px;width: 90px;">
                ...
                <input  type="button" value="搜索" style="background: #0d6aad ;height: 40px;width: 60px;"/>&nbsp;&nbsp;
                 <input type="button" value="重置" style="width: 80px;height: 40px;"/>
                <div class="box-body">
                <div class="box-body">
