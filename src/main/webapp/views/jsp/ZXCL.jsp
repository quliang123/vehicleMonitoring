            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="../jsp/ZXCL.jsp">在线车辆</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <form class="form-inline">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputAmount" placeholder="车牌号">
                            </div>
                        </div>
                        <div class="form-group">
                            <select name="s" class="form-control">
                                <option value="">车厂名称</option>
                                <option value="">广州车厂</option>
                                <option value="">上海车厂</option>
                                <option value="">北京车厂</option>
                            </select>
                            <%--   <div class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-11">
                    <table class="table table-bordered table-responsive table-striped table-condensed table-hover">
                        <tr>
                            <th class="fs-12">车牌号</th>
                            <th  class="fs-12">车辆类型</th>
                            <th  class="fs-12">车厂名称</th>
                            <th  class="fs-12">终端厂商</th>
                            <th  class="fs-12">行政区域</th>
                            <th  class="fs-12">是否在线</th>
                            <th  class="fs-12">结束里程值</th>
                            <th  class="fs-12">运行状态</th>
                            <th  class="fs-12">充电状态</th>
                            <th  class="fs-12">GPS有效性</th>
                            <th  class="fs-12">GPS是否有值</th>
                            <th  class="fs-12">故障状态</th>
                        </tr>
                        <tr>
                            <td>1</td>
                            <td>2</td>
